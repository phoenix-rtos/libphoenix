 ...
 * libphoenix
 *
 * Architecture dependent part of limits (arch/aarch64)
 *
...
#ifndef _LIBPHOENIX_ARCH_AARCH64_LIMITS_H_
#define _LIBPHOENIX_ARCH_AARCH64_LIMITS_H_
...
#define ULONG_MAX 0xffffffffffffffffLL
