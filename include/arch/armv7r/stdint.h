 ...
 * libphoenix
 *
 * Architecture dependent part of stdint (arch/armv7r)
 *
...
#ifndef _LIBPHOENIX_ARCH_ARMV7R_STDINT_H_
#define _LIBPHOENIX_ARCH_ARMV7R_STDINT_H_

#include <phoenix/arch/armv7r/stdtypes.h>
